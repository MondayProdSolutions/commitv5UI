...
/**
 * Fila de la tabla de devoluciones: navega al detalle al hacer clic o con Enter
 * (mismo contrato `{ href?, children }` que `SaleRow`).
 */
export function ReturnRow({ href, children }: DataTableRowProps) {
